  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-background text-foreground transition-colors duration-300">
      ...
      <aside
        ...
        } md:translate-x-0 md:static md:flex md:w-64 flex-col glass-panel border-r border-border p-5 no-print transition-all duration-300 ease-in-out z-40 bg-background md:bg-transparent overflow-y-auto`}
      >
